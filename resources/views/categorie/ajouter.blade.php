            ...
            <div class="panel-body">
                <div class="col-sm-12">
                    {!! Form::open(['route' => 'categorie.store']) !!}
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 {!! $errors->has('photo_categorie') ? 'has-error' : '' !!}">
                                <input type="hidden" name="photo_categorie" class="form-control" value="default.jpg">
                                {!! $errors->first('photo_categorie', '<small class="help-block">:message</small>') !!}
                            </div>
                        </div> 
                        <div class="clearfix">
