@extends('layouts.app')
  ...
  <div class="container" style="margin-top: 150px;">
    <div class="col-sm-12" style="margin-top: 100px;">
      <h3 class="text-center">Choisir un mode de paiement</h3>
      <div class="row">
        <div class="col-lg-7">
        ...
        <div class="col-lg-5" id="blocus">
          <div class="col-lg-10 offset-lg-1 box_paiement" id="block_mtn">
            <div class="row">
              <div class="col-lg-9 form-check offset-lg-1">
                ...
                <label class="form-check-label" for="mtnRadio">MTN Mobile Money</label>
              </div>
              <div class="col-lg-2">
                <img src="{{asset('public/img/mtn_momo.jpg')}}" class="img-fluid paiement_image">
              </div>
            </div>
          </div>
          <div class="col-lg-10 offset-lg-1 box_paiement" id="block_orange">
            <div class="row">
              <div class="col-lg-9 form-check offset-lg-1">
                <input class="form-check-input" type="radio" name="radios" id="orangeRadio" value="orange" state="0">
                <label class="form-check-label" for="orangeRadio">ORANGE Money</label>
              </div>
              <div class="col-lg-2">
                <img src="{{asset('public/img/orange_money.jpg')}}" class="img-fluid paiement_image" id="">
              </div>
            </div>
          </div>
        </div>
  ...
  $(function(){
    $('input[type="radio"]').on('click',function(){
      ...
      if(state == 0)
      {
        ...
        /* remettre l'etat des boutons à 1 pour qu'on puisse à nouveau cliquer */
        if(value == 'mtn')
        {
