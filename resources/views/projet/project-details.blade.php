  ...
  <div class="container" style="border:1px solid red;margin-top: 33px">
    <div class="col-sm-12">
      ...
      <div class="row" style="border:1px solid yellow">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="border:1px solid purple;padding:15px;word-wrap:break-word;">
          <p style="font-family: Times, serif; font-size:14pt; font-style:italic; font-variant: normal">
            {{$projet->objectifs_du_projet}}
          </p>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="border:1px solid red;padding:15px">
